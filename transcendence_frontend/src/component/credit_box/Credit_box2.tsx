...
function Credit_box2() {
  return (
    <div className={styles.credit_box}>
        <div className={styles.credit_box_left}>
		<img className={styles.credit_box_left_photo} src='./images/Alban.png'></img>
            <span className={styles.credit_box_left_name}>ALRUSSO</span>
